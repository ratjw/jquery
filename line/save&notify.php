...
function sendToLine($message, $imageFullsize, $imageThumbnail) {
...
//	curl_setopt($ch, CURLOPT_POSTFIELDS, 'message='.$message);
	curl_setopt($ch, CURLOPT_POSTFIELDS, $message.$imageFullsize.$imageThumbnail);
	...
	sendToLine($message, $imageFullsize, $imageThumbnail);
?>