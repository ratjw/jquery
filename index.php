...
<div id='equip'>
  ...
  <span style="width:100px;">Pudenz</span>
  ...
  <span style="width:70px;"><input type="checkbox" id="CN6"><label for="CN6">CN6</label></span>
  ...
  <span style="width:60px;"><input type="checkbox" id="CN10"><label for="CN10">CN10</label></span>
  <span style="width:60px;"><input type="checkbox" id="CN11"><label for="CN11">CN11</label></span>
  <span style="width:60px;"><input type="checkbox" id="CN12"><label for="CN12">CN12</label></span>
  <br>
  <span style="width:120px;"></span>
  <span style="width:140px;"><input type="checkbox" id="SSEP"><label for="SSEP">SSEP</label></span>
  <span style="width:140px;"><input type="checkbox" id="MEP"><label for="MEP">MEP</label></span>
  ...
  <span style="width:120px;"><input type="checkbox" id="EMG"><label for="EMG">EMG</label></span>
